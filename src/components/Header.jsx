    ...
    <header className="fixed z-50 w-screen p-6 px-16">
      ...
      <div className="hidden w-full md:flex justify-between items-center">
        <div className=" flex items-center gap-2">
          ...
          <Link to={"/login"}><button className='bg-sky-800 text-white font-bold px-4 py-2 rounded hover:bg-sky-500'>Singn Up</button></Link>
        <div className="flex items-center justify-between gap-8">
          ...
          <Link to={"/userProfile"}><img src={Avatar} alt="profile" className='w-10 min-w-[40px] h-[40px] shadow-2xl min-h-[40px] drop-shadow-lg' /></Link>
        </div>
      </div>

      {/* mobile */}
        <div className="flex h-full w-full p-2 justify-between items-center md:hidden ">
        <div className="flex relative items-center justify-center ">
             <MdShoppingBasket className='text-2xl cursor-pointer' />
             <div className=" text-gray-700 w-5 h-5 rounded-full bg-red-600 flex items-center justify-center absolute -top-3 -right-2">
              <p className='text-xs text-white font-semibold '>2</p>
